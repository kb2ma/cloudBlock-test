Example use of the cloud block with the balenablocks/sensor block as input, including a user provided `docker-compose.yml` file for configuration. Does not include custom application code.
